...
@st.cache_resource
def load_models():
    model1 = tf.keras.models.load_model("transformer_model1.keras", custom_objects={'Transformer': Transformer})
    model2 = tf.keras.models.load_model("transformer_model2.keras", custom_objects={'Transformer': Transformer})
